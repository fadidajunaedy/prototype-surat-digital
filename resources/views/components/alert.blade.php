@if (session('success'))
    <div role="alert" class="alert alert-success flex justify-between items-center">
...
@if (session('warning'))
    <div role="alert" class="alert alert-warning flex justify-between items-center">
...
@if ($errors->any())
<div role="alert" class="alert alert-error flex justify-between items-center">
    <ul>
