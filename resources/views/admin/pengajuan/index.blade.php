...
<section class="min-h-[90vh] w-full prose-sm">
    <div class="text-sm breadcrumbs px-0 ">
        <ul class="mx-0 px-0 my-0">
          <li class="mx-0 px-0">Pengajuan</li> 
          <li>List</li>
        </ul>
    </div>
    <div class="w-full flex justify-between items-center mb-4">
        <h2 class="font-semibold my-4">Pengajuan</h2>
        <a 
    ...
    <div class="overflow-x-auto bg-base-100 p-4 rounded-xl shadow-xl">
        <div class="w-full flex justify-end items-center mb-4">
            <form action="{{ route('admin.pengajuan') }}" method="GET" class="flex items-center gap-2">
                @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="flex justify-center items-center gap-2">
                        <a 
                        href="{{ url('admin/pengajuan/'.$item->id).'/edit'}}"
                ...
                <dialog id="modalConfirm{{ $item->id }}" class="modal bg-base-200 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10">
                    <div class="modal-box prose-sm">
                        ...
                        <div class="modal-action">
                            ...
                            <form action="{{ url('admin/pengajuan/'.$item->id)}}" method="POST">
                                @csrf 
                                @method('DELETE')
