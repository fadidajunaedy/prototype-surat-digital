...
<section class="min-h-[90vh] w-full prose-sm">
    ...
    <h2 class="font-semibold my-4 mb-4">Edit Editor</h2>
    @include('components.alert')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="md:col-span-2 bg-base-100 p-4 rounded-xl shadow-xl">
            <form 
            action="{{ url('admin/editor/' . $data->id . '/update') }}" 
            method="POST"
            ...
            >
                ...
                <div class="form-control w-full">
                    ...
                    <select name="role" class="select select-sm select-bordered">
                        ...
                        <option value="rt" {{ $data->role == 'rt' ? 'selected' : '' }}>RT</option>
                        <option value="rw" {{ $data->role == 'rw' ? 'selected' : '' }}>RW</option>
                    </select>
                </div>
                <div class="form-control w-full">
                    <label class="label">
